...
import p1 from "../img/persona1.jpg";
import p2 from "../img/persona2.jpg";
import p3 from "../img/persona3.jpg";
import p4 from "../img/persona4.jpg";
import p5 from "../img/persona5.jpg";
import p6 from "../img/persona6.jpg";
            ...
            <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
                <div class="w-full text-center pb-8">
                    ...
                    <h1 class="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-gray-900 pb-2">
                        Algunos de nuestros pacientes dicen!
                    </h1>
                ...
                <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white rounded-lg p-6">
                        <div class="flex items-center space-x-6 mb-4">
                            <img class="h-28 w-28 object-cover object-center rounded-full"
                                src={p1} alt="photo"></img>
                            <div>
                                <p class="text-xl text-gray-700 font-normal mb-1">Paula Ramos</p>

                            </div>
                        </div>
                        <div>
                            <p class="text-gray-400 leading-loose font-normal text-base">Hola, me paree una muy buena veterinaria para llevar a tu perrito, tambien me gusta mucho porque alli pude adoptar los cutro perros y 3 gatos que ahora me hacen feliz ademas de los buenos precios que manejan con calidad de la mano.</p>
                        </div>
                    </div>
                    <div class="bg-white rounded-lg p-6">
                        <div class="flex items-center space-x-6 mb-4">
                            <img class="h-28 w-28 object-cover object-center rounded-full"
                                src={p2} alt="photo"></img>
                            <div>
                                <p class="text-xl text-gray-700 font-normal mb-1">Cristian Franco</p>
                    ...
                    <div class="bg-white rounded-lg p-6">
                        <div class="flex items-center space-x-6 mb-4">
                            <img class="h-28 w-28 object-cover object-center rounded-full"
                                src={p3} alt="photo"></img>
                            <div>
                                <p class="text-xl text-gray-700 font-normal mb-1">JJose Pinchao</p>
                    ...
                    <div class="bg-white rounded-lg p-6">
                        <div class="flex items-center space-x-6 mb-4">
                            <img class="h-28 w-28 object-cover object-center rounded-full"
                                src={p4} alt="photo"></img>
                            <div>
                                <p class="text-xl text-gray-700 font-normal mb-1">Camilo Cano</p>
                    ...
                    <div class="bg-white rounded-lg p-6">
                        <div class="flex items-center space-x-6 mb-4">
                            <img class="h-28 w-28 object-cover object-center rounded-full"
                                src={p5} alt="photo"></img>
                            <div>
                                <p class="text-xl text-gray-700 font-normal mb-1">Andrea Peña</p>
                    ...
                    <div class="bg-white rounded-lg p-6">
                        <div class="flex items-center space-x-6 mb-4">
                            <img class="h-28 w-28 object-cover object-center rounded-full"
                                src={p6} alt="photo"></img>
                            <div>
                                <p class="text-xl text-gray-700 font-normal mb-1">Luis Hernandez</p>
