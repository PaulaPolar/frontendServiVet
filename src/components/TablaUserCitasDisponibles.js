...
import "./TablaUserCitasDisponibles.css";

const TablaUserCitasDisponibles = () => {
    return(
        <Fragment>
           ...
           <div className="contenedor-citas">
             ...
             <div className="tabla">
               ...
               <div id="grid" className="fila-2">
                 ...
                 <span className="columnas">Hernan Mendez</span>
                 <div className="icons">     
             <a href="#" class="reservar fila2 w-button">Reservar</a>
                 </div>
               </div>
...
export default TablaUserCitasDisponibles;
